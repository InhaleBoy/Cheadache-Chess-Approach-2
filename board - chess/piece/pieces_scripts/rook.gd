...
func setTexture(IngameColor : bool) -> void:
	if IngameColor : $Sprite2D.texture = load("res://board - chess/piece/textures/rook_white.png")
	else : $Sprite2D.texture = load("res://board - chess/piece/textures/rook_black.png")
